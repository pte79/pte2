const LFillInTheBlanksData = [
  ...
  {
    id: 5,
    transcript: `What is nanotechnology? A report that was put together by a <input autocomplete="off" type="text" class="blank" id="blank0"> <span class='answer hidden'>combination</span> of the Royal Society and the Royal Academy of Engineering that came out last summer, <input autocomplete="off" type="text" class="blank" id="blank1"> <span class='answer hidden'>identified</span> two topics. Nanoscience is the study of <input autocomplete="off" type="text" class="blank" id="blank2"> <span class='answer hidden'>phenomena</span> and the manipulation of materials at atomic, molecular and <input autocomplete="off" type="text" class="blank" id="blank3"> <span class='answer hidden'>macromolecular</span> scales, where properties differ significantly from those that larger scale. Nanotechnologies are the design characterization, production and application of <input autocomplete="off" type="text" class="blank" id="blank4"> <span class='answer hidden'>structures</span>, devices and systems by controlling shape and size at the nanometer scale. I will talk a little in a moment about what a nanometer is, but <input autocomplete="off" type="text" class="blank" id="blank5"> <span class='answer hidden'>loosely</span> speaking people think of nanotechnologies as being around a hundred nanometers or less.`,
    audio:
...

  {
    ...
    audio:
      "https://storage.googleapis.com/pte-assistant.appspot.com/app%2Faudio%2Flfib-88.mp3?GoogleAccessId=firebase-adminsdk-t7i9w%40pte-assistant.iam.gserviceaccount.com&Expires=1640955600&Signature=W%2BT51aMKdp6k2BJHC2gpr45HMklV39KJuR%2B9lNSJDWCT%2BBE8Yf8PTnCfjAnLfpLQPd2fhgfdeNpTxFA%2FAKtySgQ2CknoZkOAqr3n5anPg5Jqnh%2BfBasAFQyZjFnHbUAVlLr87r0dtduFutToHLLoiwDomut%2Bfvz72IE%2B5EAS0cpPomR1Tp8rxu4%2BiYcmWkqEkJfqp0ibpTnS947IbQDppPZebtMmtZCfecq0G6BgN0VeDLs6KkcHw5gyrElFdg0Iq%2BqrK4JPcez2vJ8Brjh1diM1Rs8abCzyV1DiKbRep0FsWqU42JSo12QqSlXTBWdz8HiyMXYTni4sOfk3Nwdryg%3D%3D",
    answers: [],
    level: "medium",
    times: 1,
    priority: "normal",
