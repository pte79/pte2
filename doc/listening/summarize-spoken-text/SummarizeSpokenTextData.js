...
Semantic noise doesn’t involve sound but rather <span class="text-highlight">ambiguity</span> in words, <span class="text-highlight">sentences</span> or other <span class="text-highlight">symbols</span> used in communication. The ambiguity is caused because <span class="text-highlight">everybody sees</span> a different meaning in the same <span class="text-highlight">words</span>, <span class="text-highlight">phrases</span> or sentences. The differences in interpretation can be quite small, even <span class="text-highlight">undetectable</span>, in regular communication between people from the same <span class="text-highlight">culture</span>, <span class="text-highlight">age</span>, <span class="text-highlight">education</span> and experience, or <span class="text-highlight">drastically different</span> because of such things as culture, age or experience.`,
...

  {
    ...
    transcript: `Now, we would like to look at <span class="text-highlight">a recent survey</span> <span class="text-highlight">conducted</span> by <span class="text-highlight">Canadian researchers</span> on diet. Total 31 <span class="text-highlight">woman</span> <span class="text-highlight">volunteered</span> in the survey, they have been told to <span class="text-highlight">participate in</span> the <span class="text-highlight">exercise programme</span> without <span class="text-highlight">changing their diet</span>.
    After a <span class="text-highlight">careful observation</span>, the researchers found that some volunteers <span class="text-highlight">experienced</span> a<span class="text-highlight">body fat</span> change after <span class="text-highlight">six months</span> from the day they have <span class="text-highlight">started</span> the <span class="text-highlight">experiment</span>. The findings further stated that someone <span class="text-highlight">lost</span> <span class="text-highlight">significant amount</span> fat which lead to a <span class="text-highlight">decrease</span> in<span class="text-highlight">body mass</span>. On the other hand, there were others who did not <span class="text-highlight">lose</span> fat at all. The study concludes that there must be <span class="text-highlight">two</span> <span class="text-highlight">explanations</span>. Those who <span class="text-highlight">did not lose weight</span> must have <span class="text-highlight">eaten more</span> and <span class="text-highlight">another factor</span> is that it is because their <span class="text-highlight">psychological reason</span> not to <span class="text-highlight">believe in</span> <span class="text-highlight">losing fat</span>.`,
    solution: `The lecturer talked about a survey conducted by Canadian researchers on diet. He firstly introduced that thirty-one women participated in an exercise programme without changing their diet. Additionally, he claimed that they lost significant amount of fat and this led to a decrease in their body mass. Finally, he concluded that some candidates did not lose weight because they have eaten more and due to their psychological reasons.`,
    keywords: [],
    mainIdeas: [],
    fillInTheBlank: "",
    audio:
      "https://storage.googleapis.com/pte-assistant.appspot.com/app%2Ffiles%2Finscww8xbsoz0gmk8wp3zg-Body%20Fat%20Experiment-%5BAudioTrimmer.com%5D.mp3?GoogleAccessId=firebase-adminsdk-t7i9w%40pte-assistant.iam.gserviceaccount.com&Expires=2524608000&Signature=A7VkOo5LzddKRG3QaKBMyRtZ2qnDECGvRmrejpT7jpy%2BEEcghcVdSfDDB7zFPg7bwq1omFC2lkSlgPYctUjdNq%2BHCg6Qy60rj2hIPjbFk28fF%2B4KCxPKfY41pZGqiUj9W7W4jmg%2Bln9dKlIG5l%2F%2Fea8p5AGOesktqrwk0w9Ws8gY2DiqtEVMX1L%2FOqMhXr3Pu74kE1TgAda0Nw50%2B3Fz1FwLJPNR6wAVKUoVNjok9roqrN%2FOS19XY0H3cwUbZUd%2Be9Sn5E8BfG4ZW2NPH4GLW1MDasAU5zHg59Hf%2Bx3RNgc%2B7q5V2RFmd779XK3zQh%2B%2FSi1kxM11WlM0WYVX%2BtGcLw%3D%3D",
    level: "medium",
    times: 1,
    priority: "normal",
    newwords: [],
